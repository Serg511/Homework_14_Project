...
resource "local_file" "AnsibleInventory" {
 content = templatefile("inventory.tpl",
 {
  ...
  web-0-int-ip = yandex_compute_instance.web-[0].network_interface.0.ip_address
  web-1-int-ip = yandex_compute_instance.web-[1].network_interface.0.ip_address
  web-2-int-ip = yandex_compute_instance.web-[2].network_interface.0.ip_address
  ...
  lb-0-int-ip = yandex_compute_instance.lb-[0].network_interface.0.ip_address
  lb-1-int-ip = yandex_compute_instance.lb-[1].network_interface.0.ip_address
  ...
  elk-0-int-ip = yandex_compute_instance.elk-[0].network_interface.0.ip_address
  kafka-0-ip = yandex_compute_instance.kafka-[0].network_interface.0.nat_ip_address
  prometheus-0-ip = yandex_compute_instance.prometheus-[0].network_interface.0.nat_ip_address
  prometheus-0-int-ip = yandex_compute_instance.prometheus-[0].network_interface.0.ip_address
 }
 )
 ...
 content = templatefile("hosts.tpl",
  {
   ...
   iscsi-0-ip = yandex_compute_instance.iscsi-[0].network_interface.0.ip_address
   elk-0-ip = yandex_compute_instance.elk-[0].network_interface.0.ip_address
   kafka-0-ip = yandex_compute_instance.kafka-[0].network_interface.0.ip_address
   prometheus-0-ip = yandex_compute_instance.prometheus-[0].network_interface.0.ip_address
  }
 )
